...
class TestRestaurant(unittest.TestCase):
    def setUp(self):
        ...
        self.goldent_palace = Restaurant(address, owner)

    def tearDown(self):
        print("This will run after each test!")

    def test_owner_age(self):
        self.assertEqual(self.goldent_palace.owner_age, 60)

    def test_owner_name(self):
        self.assertEqual(self.goldent_palace.owner.name, "Jackie")

    def test_summary(self):
        self.assertEqual(self.goldent_palace.summary(
