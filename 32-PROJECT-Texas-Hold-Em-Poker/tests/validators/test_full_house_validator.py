...
class FullHouseValidatorTest(unittest.TestCase):
    ...
    def test_validates_that_cards_have_two_of_the_same_rank_and_three_of_the_another_rank(self):
    ...
    def test_returns_collections_of_two_cards_of_the_same_rank_and_three_cards_of_the_same_rank(self):
        validator = FullHouseValidator(cards=self.cards)
